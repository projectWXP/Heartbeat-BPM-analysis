...
# Downsample the audio data (for demonstration)
downsample_factor = 50  # adjust as needed
...
# Add the full-resolution waveform trace
...
ax1.plot(time_windows, smart_bpm_values, marker='o', linestyle='-', color='#47a5c4', markersize=2.5, markerfacecolor='#4a4a4a')
